...
import { Button, Layout, Typography, Row, Col, Form, Input, notification, Select, Alert } from "antd";
...
class Confirmation extends React.Component {    
    ...
    onSubmitOTP = value => {        
        const otpVal = parseInt(`${value.otp1}${value.otp2}${value.otp3}${value.otp4}`,10);
                ...
                <Row >
                  ...
                  <Col span={12}>
                      <div className="formBox">
                        <Title level={1} style={{color: '#546E7A'}}>Confirm your identity</Title>
                        <Text >Before you can use your account, you must verify your phone number</Text>
                        <Form
                          // {...layout}
                        ...
                        >
                          ...
                          >
                            <Input addonBefore={prefixSelector} placeholder="XXX-XXX-XXXX" disabled={this.state.codeSent}/>
                          </Form.Item>
                            
                          <img src={captcha} alt="captcha" style={{marginBottom: '10px'}}/>
                          <Form.Item
                          ...
                          >                            
                            <Input prefix={<LockOutlined className="site-form-item-icon" />} placeholder="Secure Captcha" disabled={this.state.codeSent}/>
                          </Form.Item>                          
                        ...
                        </Form>
                        {
                            ...
                            <div style={{textAlign: "center"}}>                                
                                ...
                                <Col>
                                    <Text >Enter OTP</Text>
                                    <Form layout="inline" style={{width: '100%'}} onFinish={this.onSubmitOTP}>
                                    ...
                                    </Form>
                                    {
                                        ...
                                        <Alert message="Invalid OTP was entered" type="error" style={{marginTop: '10px'}} />
                                    }                                    
                                </Col>
                                </Row>
                            </div>
